...
SECRET_KEY = "django-insecure-0uziq(6x6i=1d$6^dl2nbzr0!*&z7^#ju+0gc((_e4k1iz@+uo"
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("DB_NAME", "instagram_stats"),
        "USER": os.environ.get("DB_USER", "aalis"),
        "PASSWORD": os.environ.get("DB_PASSWORD", "finger1992"),
...
CELERY_BEAT_SCHEDULE = {
    "update_followers_count": {
        ...
        "schedule": timedelta(minutes=5),  # Run every 24 hours
    },
}
